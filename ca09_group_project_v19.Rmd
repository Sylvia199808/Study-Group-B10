...
We found adjusted R2 of model1 is only 0.4395, which is extremely low. Residuals of model1 do not obey Normal Distribution well. Therefore, We need more explanatory variables for regression. 
...
Difference of RMSE between Training data set and testing data set is not very large, which indicates model1 does not overfit the data.
...
According to p-value, `room_type` is significant variable except for `room_typeHotel room`.
...
We found adjusted R2 of model1 is only 0.4718, which is still low. Residuals of model2 do not obey Normal Distribution well. Therefore, We need more explanatory variables for regression.
...
Difference of RMSE between Training data set and testing data set is not very large, which indicates model2 does not overfit the data.
...
According to the p-value, `beds` is non-significant variable and we should remove it from the model. 
...
```
We found adjusted R2 of model3 is only 0.5848, which is much higher. Residuals of model3 roughly obeys Normal Distribution well. We could add more explanatory variables for regression.
...
model4 %>% 
  ...
  kable_styling()
```
According to the p-value, `host_is_superhost`commands a pricing premium, after controlling for other variables.
...
We found adjusted R2 of model1 is only 0.5524, which is much higher. Residuals of model4 roughly obey Normal Distribution well. We could add more explanatory variables for regression.
