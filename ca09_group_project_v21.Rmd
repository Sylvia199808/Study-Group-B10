...
date: "12 Oct 2021"
author: "Study Group 10: Mario Cardoso Pucinelli Filho, Isahelen Chen, Sylvia Hu, Aditya Khurana, Emilie Manolas, Vasileios Papoutsoglou, Akos Ersek"
output:
  html_document:
    highlight: zenburn
    theme: flatly
...
Some hosts allow you to immediately book their listing (`instant_bookable == TRUE`), while a non-trivial proportion don't.We want to know, after controlling for other variables, if `instant_bookable` is a significant predictor of `price_4_nights`.
...
ADD INTERPRETATION OF THESE LAST RESULTS
